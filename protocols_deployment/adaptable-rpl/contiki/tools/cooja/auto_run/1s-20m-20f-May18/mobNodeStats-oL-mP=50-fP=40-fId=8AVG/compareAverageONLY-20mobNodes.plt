...
set style histogram gap 1 clustered #rowstacked
...
plot "mobNodeStats-1s-20m-20f-A-RX100%-1hr.csc.log" u 2:xtic(1) t "Adaptable" fillstyle pattern 2,\
"mobNodeStats-1s-20m-20f-Dy-RX100%-1hr.csc.log" u 2 t "Dynamic" fillstyle pattern 4
