...
<simconf>
  ...
  <simulation>
    ...
    <mote>
      ...
      <interface_config>
        ...
        <x>27.742358692060936</x>
        <y>-23.359952703858895</y>
        <z>0.0</z>
      </interface_config>
      <interface_config>
    ...
    <mote>
      ...
      <interface_config>
        org.contikios.cooja.interfaces.Position
        <x>16.180357254069776</x>
        <y>41.46616375202305</y>
        <z>0.0</z>
      </interface_config>
      <interface_config>
        org.contikios.cooja.mspmote.interfaces.MspClock
  ...
  <plugin>
    ...
    <plugin_config>
      ...
      <viewport>2.2130984967311056 0.0 0.0 2.2130984967311056 112.43581404646096 98.21606289724832</viewport>
    </plugin_config>
    <width>822</width>
    <z>5</z>
    <height>586</height>
  ...
  <plugin>
    Mobility
    <plugin_config>
      <positions EXPORT="copy">[APPS_DIR]/mobility/straight120sec.dat</positions>
    </plugin_config>
    <width>500</width>
    <z>4</z>
    <height>200</height>
